...
As a data analysis and visualization enthusiast, as well as a passionate urban cyclist and supportert of sustanible mobility, when I discovered that the Florence municipality OpenData office had released an open dataset about the road accidents that involved cyclists in my own town, I immediately decided to download it and to try to conduct some analyses for my first blog post on the use of R.In what follows I'll present the results of the analsyes along with the code I've writted to perform them. 
...
These last two plots do not reveal any particularly interesting pattern.  Nel mese di maggio, apparentemente, i sinistri tendono ad assere più frequenti il venerdì ed il sabato rispetto a quanto avvenga negli altri mesi, mentre ad agosto sembra esserci una minore differenza nella frequenza dei sinstri durante la settimana, presumibilmente perché in quel mese tipicamente mese di ferie, la mobilità ciclistica per recarsi al lavoro diminuisce. 


## Closing remarks

I hope this journey in the accidents involving cyclists in Florence has interested you. My  initial idea, as I said before, was only to make an interactive map of the accidents, but, as it often happens, I got hooked in the analyes and couldn't stop ...    
